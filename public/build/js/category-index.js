(function ($) {
    ...
    function frmlanguage() {
        this.clearInput = function () {
            $('#frm-language').attr('action', _base + '/products/category');
            $('input[type="text"]').val('');
            $('input[name="id"]').val(0);
            $('input[name="_method"]').val('POST');
        }
        this.edit = function (id) {
            $('#frm-language').attr('action', _base + '/products/category/' + id);
            $.ajax({
                url: _base + '/products/category/' + id + '/edit',
                success: function (data) {
                    ...
                    if (data.code == 200) {
                        ...
                        $('#preview').html('<img src="' + _base +'/public/images/contents/' + res.attach.attach_file +'"/>');
        ...
        this.delete = function (id) {
            $.ajax({
                url: _base + '/products/category/' + id,
                method: 'POST',
        ...
        this.checker = function ($input) {
            ...
            $.ajax({
                url: _base + '/products/category/checker',
                data: {
