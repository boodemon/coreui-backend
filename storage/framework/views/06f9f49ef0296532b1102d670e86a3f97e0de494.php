        ...
        <table class="table table-sm table-data table-bordered">
          <thead>
            <tr>
                ...
                <th class="w120">Equipmentcode</th>
          ...
          <tbody>
              <?php if($rows ): ?>
                ...
                <tr>
                    ...
                    <td><?php echo e($row->equipmentcode); ?></td>
...
<?php $__env->startSection('modal'); ?>
    <?php echo $__env->make('backend.carrier.import', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('javascript'); ?>
    <script src="<?php echo e(asset('public/build/js/carrier-index.js')); ?>"></script>
<?php $__env->stopSection(); ?>
