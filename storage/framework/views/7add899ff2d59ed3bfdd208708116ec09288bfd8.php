...
<div class="row">
                    ...
                    <tbody>
                      <tr>
                        <td class="text-center">
                          <div class="avatar">
                            <img src="<?php echo e(asset('public/img/avatars/1.jpg' )); ?>" class="img-avatar" alt="admin@bootstrapmaster.com">
                        ...
                        <td class="text-center">
                          <img src="<?php echo e(asset('public/img/flags/USA.png' )); ?>" alt="USA" style="height:24px;">
                        </td>
                        <td>
                          <div class="clearfix">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <img src="<?php echo e(asset('public/img/flags/Brazil.png' )); ?>" alt="Brazil" style="height:24px;">
                        </td>
                        <td>
                          <div class="clearfix">
                            <div class="float-left">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <img src="<?php echo e(asset('public/img/flags/India.png' )); ?>" alt="India" style="height:24px;">
                        </td>
                        <td>
                          <div class="clearfix">
                            <div class="float-left">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <img src="<?php echo e(asset('public/img/flags/France.png' )); ?>" alt="France" style="height:24px;">
                        </td>
                        <td>
                          <div class="clearfix">
                            <div class="float-left">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <img src="<?php echo e(asset('public/img/flags/Spain.png' )); ?>" alt="Spain" style="height:24px;">
                        </td>
                        <td>
                          <div class="clearfix">
                            <div class="float-left">
                      ...
                      <tr>
                        ...
                        <td class="text-center">
                          <img src="<?php echo e(asset('public/img/flags/Poland.png' )); ?>" alt="Poland" style="height:24px;">
                        </td>
                        <td>
                          <div class="clearfix">
                            <div class="float-left">
        ...
        <script src="<?php echo e(asset('public/js/views/main.js')); ?>"></script>
        <?php $__env->stopSection(); ?>
